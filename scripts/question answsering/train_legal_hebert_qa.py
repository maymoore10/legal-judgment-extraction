...
tokenizer = BertTokenizerFast.from_pretrained('avichr/Legal-heBERT')
...
output_dir = os.path.join(models_path, f'{today_format}/mixed/finetuned_legalhebert_qa_3e-05_q0')
